...
│   ├── 15_open_visibility.sql   ให้ผู้ขายเห็นประกาศก่อนถึงเวลาเปิด (ยื่นราคายังไม่ได้)
│   ├── 16_remark.sql            หมายเหตุถึงผู้ขาย (คอลัมน์ tenders.remark)
│   ├── 17_restore_buyer.sql     คืนสิทธิฝ่ายจัดซื้อให้บัญชีที่หลุด + กันไม่ให้ถูกลดชั้นอีก
│   ├── 18_rebuild_profiles.sql  กู้บัญชีที่เด้งออกทั้งหมด จากร่องรอยในฐานข้อมูล
│   ├── 19_winner_docs.sql       ผู้ชนะส่งเอกสารได้หลังประกาศผล
│   └── 20_hide_bid_events.sql   ปิดความเคลื่อนไหวเรื่องราคาไม่ให้ผู้ขายเห็น
├── scripts/
